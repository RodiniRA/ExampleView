        ...
        public static IEnumerable<Accent> Accents
        {
            get
            {
                ...
                try
                {
                    ...
                    var testResourceAddress = (new Uri("Styles\\Accents\\TestAccent.xaml", UriKind.Relative));
                    _accents.Add(new Accent("TEST", testResourceAddress));
                }
                catch (Exception e)
                {
